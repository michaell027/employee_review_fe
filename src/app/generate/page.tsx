            ...
            <>
              ...
              <div className="mt-4 gap-3 flex justify-end">
                <button
                  ...
                  className="bg-purple-500 mb-8 text-white px-4 py-2 rounded-md hover:bg-purple-700 transition-colors"
                >
                  Request Changes
                </button>
                <button
                  onClick={handleRequestChanges}
                  className="bg-purple-950 mb-8 text-white px-4 py-2 rounded-md hover:bg-purple-700 transition-colors"
                >
                  Accept & Send
                </button>
              </div>
